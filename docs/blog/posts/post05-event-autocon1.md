...
??? question "Help Me Understand the Money Flow - RFC"
    ...
    I’m patient - but I too would like to be rich before I die:
      ...
      - Being able for afford a Vision Pro & Cisco U subscription... :material-timer: 
...
!!! info "The Cycle of Life (and Networks)"
    ...
    ```mermaid
    graph LR
        A[Plan] --> B[Build] --> C[Operate] --> D[BLAH] --> E[to Infinity]
    ```
...
!!! note "Awe & Wonder Blooms"
    I’m currently in the awe and wonder naive and blissfully ignorant stage. I’m quite sure multitudinous skeptics and negative commentary will emerge that will prune my absurd expectations. I expect [AutoCon2 in Denver](https://networkautomation.forum/autocon2) this November to open my eyes to this project more. But right now I’m just grateful for Wim and everything Nokia are doing to bridge the gap to our dreams. Thank you. :material-heart:{ .bounce } 

And now for my exquisitely profound *[(i’m British)](https://en.wikipedia.org/wiki/British_humour)* insight to bring this all together as we approach the *“moment of the conference”* and the battle of accrued wisdom and naive hope. 
